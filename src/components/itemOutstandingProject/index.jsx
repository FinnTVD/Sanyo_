    ...
    >
      ...
      <Link
        className={`itemOutStandingProject_overlay max-md:flex-col flex relative h-fit backdrop-blur-[12.5px] rounded-[0.5rem] justify-between md:items-center
          ...
          bottom-[0.59rem] ${
            !duAn ? 'py-[0.645rem]' : 'py-[0.45rem]'
          } pl-[1.06rem]  pr-[1.38rem]`}
      ...
      >
        ...
        <div className='flex items-center'>
          <span
            className={` font-Iciel text-[0.875rem] font-normal leading-1.5 text-white max-md:w-[14.1875rem] max-md:text-[0.75rem] max-lg:text-[1.3rem] text-ellipsis line-clamp-2 ${
              !duAn ? 'w-[19.75rem]' : 'w-[17.75rem]'
            } notranslate`}
          >
            {nameProject ||
              data?.title ||
              'Intercontinental Hotel, Hangzhou,Zhejiang, China'}
          </span>
          <div>
