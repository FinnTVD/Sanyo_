    ...
    <section className='relative'>
      <div className='flex relative border-b border-[rgba(28,32,28,0.10)]'>
        ...
        <div className='w-[70%] pl-[5.85rem] relative max-md:w-full max-md:pl-0'>
          <h2
            className='text-[4.375rem] font-semibold leading-1.2 font-SVNLagu text-gray-900 mb-4 mt-[8.31rem] max-md:text-center max-md:text-[1.5rem] max-md:mt-[3.93rem] [&>p>strong]:text-yellow-500 [&>p>strong]:font-semibold [&>p>strong]:uppercase'
