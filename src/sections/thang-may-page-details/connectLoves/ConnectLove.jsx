      ...
      <div className='flex pl-[6.25rem] max-md:px-3 max-md:pb-4'>
        ...
        >
          <div className='w-fit pt-[5.06rem] max-md:hidden'>
            ...
            <div className=' w-fit  flex items-center group right-[6.25rem] bottom-[50%] max-md:bottom-0 max-md:left-0'>
              <ButtonSlide
                className={
        ...
        >
          <div className='w-[44.875rem] pt-[3.37rem]'>
            <h2
              className='font-SVNLagu text-[3.415rem] font-semibold leading-1.3 text-grey-900 mb-[0.94rem] max-md:text-[1.5rem] max-md:mb-[0.62rem] [&>p>strong]:text-yellow-500 [&>p>strong]:font-semibold max-md:w-[20rem]'
