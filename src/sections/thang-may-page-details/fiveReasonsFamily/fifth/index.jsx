  ...
  return (
    <div className='pt-[5.12rem]  bg-[#42484F] text-white relative h-[58rem] fiththReason max-md:h-fit w-full max-md:pt-[3rem] max-md:pb-1'>
      ...
      <div className='flex items-center mb-[3.38rem] pl-[6.25rem] max-md:mb-[1.5rem] max-md:pl-3'>
        <p className='font-SVNLagu text-[3.125rem] leading-1.3 font-semibold  max-md:text-[1.25rem]  md:hidden mr-1'>
          5.{' '}
        </p>
        <Fade
          direction='up'
        ...
        >
          <h3
            className='font-SVNLagu text-[4rem] font-semibold leading-1.5 max-md:text-[1.25rem]  [&>p>strong]:font-semibold [&>p>strong]:text-yellow-500  [&>p>strong]:uppercase'
